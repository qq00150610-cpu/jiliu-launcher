...
public final class ItemAppBinding implements ViewBinding {
  ...
  private ItemAppBinding(@NonNull LinearLayout rootView, @NonNull ImageView appIcon,
      @NonNull TextView appName, @NonNull TextView appPackage, @NonNull TextView appType,
  ...
  public static ItemAppBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.app_type;
      TextView appType = ViewBindings.findChildViewById(rootView, id);
      if (appType == null) {
        break missingId;
      }
      ...
      return new ItemAppBinding((LinearLayout) rootView, appIcon, appName, appPackage, appType,
          appVersion);
    }
